 ...
 * @provides testcases
 *
 * Name: Klemens Koszarek and Vinny Infusino
...
void testcases(void)
{
    ...
    kprintf("3) Create three processes that typedef int MyCustomTypest user_yield syscall\r\n");
    kprintf("P) Ticket Test Case\r\n");
    ...
    case '3':
        ...
        ready(create((void *)testmain, INITSTK, 10, "MAIN1", 2, 0, NULL),
              RESCHED_NO);
    ...
    case 'P':
          ...
          ready(create((void *)testmain2, INITSTK, 50, "MAIN4", 2, 0, NULL),
                RESCHED_NO);
          ready(create((void *)testmain2, INITSTK, 20, "MAIN5", 2, 0, NULL),
                RESCHED_NO);
          ready(create((void *)testmain2, INITSTK, 8, "MAIN6", 2, 0, NULL),
                RESCHED_YES);
